...
// Package update finds newer VectoraDB releases on GitHub, verifies downloads
// against the release's SHA256SUMS, and installs them: the notice `vdb start`
// prints and the `vdb update` command. Everything here is platform-independent;
