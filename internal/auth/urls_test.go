...
func TestURLDefaults(t *testing.T) {
	...
	pub, web = urlDefaults(env(map[string]string{"VECTORADB_PUBLIC_URL": "https://db.example.com/"}))
	...
	pub, web = urlDefaults(env(map[string]string{"VECTORADB_PUBLIC_URL": "https://api.example.com", "VECTORADB_WEB_ORIGIN": "https://app.example.com"}))
